...
export default {
  data: function () {
    return {
      rates: {
        receivable: [
          0, 1.0799, 1.0922, 1.0984, 1.1045, 1.11, 1.1178, 1.128, 1.11238, 1.1268, 1.1298, 1.1348, 1.1398, 1.17, 1.175, 1.18, 1.185, 1.19, 1.2
        ],
        limit: [
          0, 0.074, 0.0845, 0.0896, 0.0947, 0.0991, 0.1055, 0.1079, 0.1102, 0.1126, 0.1150, 0.1188, 0.1227, 0.1451, 0.1490, 0.153, 0.156, 0.16, 0.1680
        ]
